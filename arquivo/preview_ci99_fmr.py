...
# Salvar CSV
# ==========================================================
csv_path = OUT_DIR / "preview_ci95_ci99_fmr_by_bw.csv"
...
plt.title("Prévia do IA-FMR: vazão agregada média com IC99%")
plt.grid(True, alpha=0.3)
plt.legend()
plt.tight_layout()

fig_path = OUT_DIR / "preview_throughput_ci99_fmr.png"
...
plt.title("Prévia do IA-FMR: IC99 relativo da vazão agregada")
plt.grid(True, alpha=0.3)
plt.legend()
plt.tight_layout()

fig_path2 = OUT_DIR / "preview_ic99_relative_fmr.png"
