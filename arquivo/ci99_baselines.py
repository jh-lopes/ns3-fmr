...
# ==========================================================
# Coleta vazão agregada por seed, banda e modo
# ==========================================================
...
# Salvar CSV
# ==========================================================
csv_path = OUT_DIR / "ci95_ci99_baselines_by_bw.csv"
...
plt.title("Baselines: vazão agregada média com IC99%")
plt.grid(True, alpha=0.3)
plt.legend()
plt.tight_layout()

fig_path = OUT_DIR / "throughput_ci99_baselines.png"
...
plt.xlabel("Largura de banda (MHz)")
plt.ylabel("IC99 relativo (%)")
plt.title("Baselines: IC99 relativo da vazão agregada")
plt.grid(True, alpha=0.3)
plt.legend()
plt.tight_layout()

fig_path2 = OUT_DIR / "ic99_relative_baselines.png"
